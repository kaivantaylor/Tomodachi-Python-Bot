...
Please insert the "ffmpeg" foler in the root of your C: or D: directory. If not "C", or "D" whatever your main directory is.
...
Now you should be able to run the server with the music bot. Just double click the "Kai_Bot" .py program, or run in IDLE.
